...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,176 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-09 — curated hub of open generative-media tools and pipelines
* [Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,255 | 🐛 3 | 🌐 Shell | 📅 2026-09-08 — runtime for generative-media prompts
* [ai-creator-academy](https://github.com/Anil-matcha/ai-creator-academy) ⭐ 2,007 | 🐛 0 | 📅 2026-08-21 — free curriculum teaching creators how to monetize the models compared in this list
* [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 190 | 🐛 5 | 📅 2026-08-27 — sister list: compare AI **video** models by API, price & speed
...
* [awesome-flux-3-api-prompts](https://github.com/Anil-matcha/awesome-flux-3-api-prompts) ⭐ 144 | 🐛 2 | 📅 2026-08-20 — FLUX 3 API guide, prompts, and parameters
...
* [Awesome-GPT-Image-2-API-Prompts](https://github.com/Anil-matcha/Awesome-GPT-Image-2-API-Prompts) ⭐ 19 | 🐛 0 | 📅 2026-09-03 — prompt library for GPT Image
...
* **[AUTOMATIC1111 WebUI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) ⭐ 164,871 | 🐛 2,506 | 🌐 Python | 📅 2026-03-02** — the classic all-in-one UI
* **[ComfyUI](https://github.com/comfyanonymous/ComfyUI) ⭐ 132,205 | 🐛 4,823 | 🌐 Python | 📅 2026-09-09** — node-based, most powerful for custom pipelines
* **[Fooocus](https://github.com/lllyasviel/Fooocus) ⭐ 52,948 | 🐛 314 | 🌐 Python | 📅 2025-12-01** — simplest "just works" UI
* **[InvokeAI](https://github.com/invoke-ai/InvokeAI) ⭐ 28,171 | 🐛 376 | 🌐 Python | 📅 2026-09-06** — polished pro/creative UI
...
*Maintained alongside [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 190 | 🐛 5 | 📅 2026-08-27 and [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,176 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-09. Found it useful? ⭐ the repo.*
