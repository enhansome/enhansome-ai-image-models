...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 27,575 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-02 — curated hub of open generative-media tools and pipelines
* [Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,205 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 — runtime for generative-media prompts
* [ai-creator-academy](https://github.com/Anil-matcha/ai-creator-academy) ⭐ 1,987 | 🐛 0 | 📅 2026-08-21 — free curriculum teaching creators how to monetize the models compared in this list
* [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 189 | 🐛 4 | 📅 2026-08-27 — sister list: compare AI **video** models by API, price & speed
...
* [Awesome-GPT-Image-2-API-Prompts](https://github.com/Anil-matcha/Awesome-GPT-Image-2-API-Prompts) ⭐ 17 | 🐛 0 | 📅 2026-08-08 — prompt library for GPT Image
...
* **[AUTOMATIC1111 WebUI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) ⭐ 164,769 | 🐛 2,503 | 🌐 Python | 📅 2026-03-02** — the classic all-in-one UI
* **[ComfyUI](https://github.com/comfyanonymous/ComfyUI) ⭐ 131,171 | 🐛 4,781 | 🌐 Python | 📅 2026-09-02** — node-based, most powerful for custom pipelines
* **[Fooocus](https://github.com/lllyasviel/Fooocus) ⭐ 52,684 | 🐛 314 | 🌐 Python | 📅 2025-12-01** — simplest "just works" UI
* **[InvokeAI](https://github.com/invoke-ai/InvokeAI) ⭐ 28,113 | 🐛 382 | 🌐 Python | 📅 2026-09-01** — polished pro/creative UI
...
*Maintained alongside [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 189 | 🐛 4 | 📅 2026-08-27 and [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 27,575 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-02. Found it useful? ⭐ the repo.*
