...
* [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,909 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-19 — curated hub of open generative-media tools and pipelines
* [Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,308 | 🐛 4 | 🌐 Shell | 📅 2026-09-08 — runtime for generative-media prompts
...
* [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 193 | 🐛 7 | 📅 2026-09-18 — sister list: compare AI **video** models by API, price & speed
...
* **[AUTOMATIC1111 WebUI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) ⭐ 165,031 | 🐛 2,504 | 🌐 Python | 📅 2026-03-02** — the classic all-in-one UI
* **[ComfyUI](https://github.com/comfyanonymous/ComfyUI) ⭐ 134,038 | 🐛 4,899 | 🌐 Python | 📅 2026-09-20** — node-based, most powerful for custom pipelines
* **[Fooocus](https://github.com/lllyasviel/Fooocus) ⭐ 53,107 | 🐛 314 | 🌐 Python | 📅 2025-12-01** — simplest "just works" UI
* **[InvokeAI](https://github.com/invoke-ai/InvokeAI) ⭐ 28,251 | 🐛 370 | 🌐 Python | 📅 2026-09-15** — polished pro/creative UI
...
*Maintained alongside [awesome-ai-video-models](https://github.com/Anil-matcha/awesome-ai-video-models) ⭐ 193 | 🐛 7 | 📅 2026-09-18 and [Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) ⭐ 28,909 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-19. Found it useful? ⭐ the repo.*
